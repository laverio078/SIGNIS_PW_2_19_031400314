...
('ID.RA-6', 'IDENTIFY', 'Risk Assessment', 'Risposte al rischio identificate e prioritizzate'),
...
('RS.AN-5', 'RESPOND', 'Analysis', 'Processi definiti per vulnerabilità da fonti esterne (es. CSIRT)'),
