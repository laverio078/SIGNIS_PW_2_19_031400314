...
/* Estrazione  dello storico modifiche (Audit Trail) per l'asset critico 'Oracle Exadata' */
/* Verifica le modifiche avvenute su un asset specifico (es. il Oracle Exadata - DB Veicoli). */
